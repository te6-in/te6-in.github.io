...
function setFixedViewportHeights() {
	if (isMobile()) {
		...
		document.getElementById("fixed-viewport-height-1").style.marginBottom = 13 * vh + "px";
		document.getElementById("fixed-viewport-height-2").style.marginTop = 80 * vh + "px";
		document.getElementById("fixed-viewport-height-2").style.marginBottom = 84 * vh + "px";
	}
}
